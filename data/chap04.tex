...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_B0_single_result}
    ...
    & 准确率 & 正确率 & 召回率 & F1值 \\
    \hline
    CNN + 最大池 & 0.8056 & 0.5834 & 0.6098 & 0.5922 \\ % Bb03_cnn_ek_1553500207

    \hline


    GRU & 0.8748 & 0.6439 & 0.5578 & 0.5719 \\ % Bb03_gru_ek_1553498587
    \hline

    BiGRU & 0.8748 & 0.6439 & 0.5578 & 0.5719 \\ % Bb03_bgru_ek_1553498459
    \bottomrule[1.5pt]
    \end{tabularx}
  \end{minipage}
\end{table}
