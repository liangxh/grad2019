...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_A_single_result}
    ...
    \hline
    LSTM & 0.6390 (11) & 0.5276 (11) & 0.8617 (1) & 0.6545 (4) \\ % A_lstm_ek_1553071939
    ...
    BiLSTM+注意力机制 & 0.6888 (1) & 0.5861 (2) & 0.7331 (10) & 0.6514 (6) \\ % A_blstm_ek_1553583756
    \hline
    2层BiLSTM & 0.6709 (5) & 0.5577 (5) & 0.8232 (2) & 0.6649 (1) \\ % A_nblstm_ek_1554346535
    2层BiLSTM+注意力机制 & 0.6888 (1) & 0.5870 (1) & 0.7267 (12) & 0.6494 (8) \\ % A_nblstm_ek_1554346515
    \hline
    \bottomrule[1.5pt]
    \end{tabularx}
  \end{minipage}
...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_B_result}
    ...
    & 准确率 & 正确率 & 召回率 & F1值 \\
    \hline
    CNN & 0.6531 (4) & 0.5090 (1) & 0.4667 (5) & 0.4432 (7) \\ % B_cnn_ek_1554446864
    ...
    \hline
    BiGRU & 0.6722 (1) & 0.4868 (4) & 0.4779 (2) & 0.4768 (1) \\ % B_bgru_ek_1554447516
    ...
    2层BiLSTM+注意力机制 & 0.6314 (8) & 0.4824 (5) & 0.4864 (1) & 0.4657 (2) \\ % B_nblstm_ek_1554448594
    \bottomrule[1.5pt]
    \end{tabularx}
  \end{minipage}
\end{table}
...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_Bb01_result}
    ...
    & 准确率 & 正确率 & 召回率 & F1值 \\
    \hline
    CNN & 0.7991 (5) & 0.7438 (5) & 0.7791 (6) & 0.7562 (5) \\ % Bb01_cnn_ek_1554448736
    CNN+注意力机制 & 0.6829 (12) & 0.6494 (11) & 0.6909 (11) & 0.6470 (11) \\ % Bb01_cnn_ek_1554448788
    \hline
    GRU & 0.8100 (2) & 0.7566 (2) & 0.7944 (2) & 0.7699 (3) \\ % Bb01_gru_ek_1554448924
    GRU+注意力机制 & 0.7677 (8) & 0.7196 (8) & 0.7679 (9) & 0.7303 (8) \\ % Bb01_gru_ek_1554449053
    \hline
    BiGRU & 0.8085 (3) & 0.7565 (3) & 0.7993 (1) & 0.7705 (2) \\ % Bb01_bgru_ek_1554449115
    BiGRU+注意力机制 & 0.7425 (10) & 0.3713 (12) & 0.5000 (12) & 0.4261 (12) \\ % Bb01_bgru_ek_1554449693
    \hline
    LSTM & 0.8053 (4) & 0.7525 (4) & 0.7932 (3) & 0.7661 (4) \\ % Bb01_lstm_ek_1554449707
    LSTM+注意力机制 & 0.8257 (1) & 0.7717 (1) & 0.7791 (6) & 0.7752 (1) \\ % Bb01_lstm_ek_1554449864
    \hline
    BiLSTM & 0.7551 (9) & 0.7169 (9) & 0.7734 (8) & 0.7236 (9) \\ % Bb01_blstm_ek_1554449881
    BiLSTM+注意力机制 & 0.7174 (11) & 0.6909 (10) & 0.7460 (10) & 0.6889 (10) \\ % Bb01_blstm_ek_1554450198
    \hline
    2层BiLSTM & 0.7849 (7) & 0.7339 (7) & 0.7795 (5) & 0.7465 (7) \\ % Bb01_nblstm_ek_1554450231
...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_Bb02_result}
    ...
    & 准确率 & 正确率 & 召回率 & F1值 \\
    \hline
    CNN & 0.8656 (1) & 0.7634 (1) & 0.6167 (7) & 0.6473 (7) \\ % Bb02_cnn_ek_1554450719
    ...
    2层BiLSTM+注意力机制 & 0.8513 (2) & 0.7076 (2) & 0.6806 (1) & 0.6924 (1) \\ % Bb02_nblstm_ek_1554451575
    \bottomrule[1.5pt]
    \end{tabularx}
  \end{minipage}
\end{table}
...
\begin{table}[htb]
  ...
  \label{tab:exp_irony_det_Bb03_result}
    ...
    & 准确率 & 正确率 & 召回率 & F1值 \\
    \hline
    CNN & 0.8860 (1) & 0.7123 (1) & 0.5781 (2) & 0.6016 (1) \\ % Bb03_cnn_ek_1553500286
    CNN+注意力机制 & 0.7981 (11) & 0.4930 (8) & 0.4934 (11) & 0.4932 (7) \\ % Bb03_cnn_ek_1554453416
    \hline
    GRU & 0.8336 (10) & 0.5873 (3) & 0.5836 (1) & 0.5853 (2) \\ % Bb03_gru_ek_1554452318
